...
const Example2 = (props) => {
    return (
        <div>
            ...
            <Form submit={(event) => {
                props.handleSubmit(event, 'Example 2')
            }}>
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Form submit={(event) => {
                    props.handleSubmit(event, 'Example 3')
        ...
        return (
            <div>
                <div style={{display: 'inline-block', width: 400, float: 'left'}}>
                    ...
                    <Form submit={(event) => {
                        props.handleSubmit(event, 'Example 4')
                    }} validityChange={this.onValidityChange} afterReset={this.onAfterReset}>
                ...
                <div style={{display: 'inline-block', width: 400}}>
                    <ul>
                        {(() => state.failures.map((failure, index) => <li className="invalid"
                                                                           key={index}>{failure}</li>))()}
                    </ul>
                </div>
            </div>
        );
...
const Example5 = (props) => {
    ...
    return (
        <div>
            <h2>Custom Inputs</h2>
            <Form submit={(event) => {
                props.handleSubmit(event, 'Example 5')
            }}>
                <TwitterTextArea name="tweet" maxLength={tweetLength}
                                 validations={[{presence: true}, {length: {maximum: tweetLength}}]}/>
