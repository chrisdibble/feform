...
var findInputs = function findInputs(children, valueChange) {
    ...
    _react2.default.Children.forEach(children, function (child) {
        ...
        var childKey = _lodash2.default.isUndefined(child.key) ? 'feinput-child' + context.childIndex++ : child.key;
        if (child && child.type && child.type.displayName === 'feinput') {
            ...
            if (child && child.props && child.props.children) {
                var childInputs = findInputs(child.props.children, valueChange, context, depth + 1);
